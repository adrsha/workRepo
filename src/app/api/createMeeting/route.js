...
export async function POST(request) {
  try {
    ...
    const { classId, startDate, endDate, className } = await request.json();
    ...
    // Update the meeting URL in the database
    ...
    return NextResponse.json({
      ...
      hostUrl: meetingData.hostRoomUrl || meetingData.roomUrl // Fallback if hostRoomUrl is not provided
    });
  } catch (error) {
