...
export async function POST(req) {
    try {
        ...
        const { courseId, gradeId, startTime, endTime, classDescription } = body;
        ...
        const response = await insertClasses(teacherId, courseId, gradeId, startTime, endTime, classDescription);
...
async function insertClasses(userId, courseId, gradeId, startTime, endTime, classDescription) {
    try {
        const result = await executeQueryWithRetry({
            query: `INSERT INTO classes (course_id, teacher_id, grade_id, start_time, end_time, class_description) VALUES (?, ?, ?, ?, ?, ?)`,
            values: [courseId, userId, gradeId, startTime, endTime, classDescription],
        });
        return result;
    } catch (err) {
