...
const fetchPublicContent = async () => {
    const query = `
    SELECT c.content_id, c.content_type, c.content_data, c.created_at, c.is_public, cc.classes_id as class_id
    FROM content c 
    JOIN classes_content cc ON cc.content_id = c.content_id
    WHERE is_public = 1
